...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001769437975 -1001855645227 -1002341400111 -1002411436292 -1002294594986').split()]  # Channel id for auto indexing (make sure bot is admin)
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_open_link_ak/24')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '28a9d50fc1c6c070c68992e157fcd0fd9d3a9f2a')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open_link_ak/24')  # Tutorial video link for opening shortlink website
