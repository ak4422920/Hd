...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1049173662 7251898668').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001769437975 -1001855645227').split()]  # Channel id for auto indexing (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002262595584'))  # Notification of those who verify will be sent to your channel
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002442422204').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ak:ak@cluster0.9zbdv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://hd:hd@cluster0.39yhk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002374888453'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/akhowtoopenlinks/34')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '4ed9f7b048d0c13394d7799f605e51a11dfacbe6')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/akhowtoopenlinks/34')  # Tutorial video link for opening shortlink website
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+d53EWGQA-tZkN2M9')
