...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("🔞 Aᴅᴜʟᴛ", url=f"https://t.me/gandicheez1"),
...
#Deendayal403
        ...
        buttons = [[
            InlineKeyboardButton('× ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ ×', url="https://t.me/Cineoriginals")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/movie_seriesgroup"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/akmoviebotz")
       ],[
            InlineKeyboardButton('• 🔞 Aᴅᴜʟᴛ •', url="https://t.me/gandicheez1"),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• ᴅᴇᴠᴇʟᴏᴘᴇʀ', user_id=int(7251898668)),
        ...
        buttons = [[
            InlineKeyboardButton('sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 📜', url='https://t.me/AKMovieBotz'),
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                    ...
                    if is_misspelled:
                        await ai_sts.edit(f'<b>✅Hᴅʜᴜʙ𝟺ᴜ Bᴏᴛ sᴜɢɢᴇsᴛᴇᴅ <code> {is_misspelled}</code> \nsᴏ ɪᴍ sᴇᴀʀᴄʜɪɴɢ ғᴏᴛ <code>{is_misspelled}</code></b>')
